...
public class addbalance extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getDataFromDataBase();
        confirm=(Button)findViewById(R.id.confirmbal);

        confirm.setTextColor(Color.WHITE);
        confirm.setBackgroundColor(Color.BLACK);

        balanceamount=(EditText) findViewById(R.id.addamount);
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                x=balanceamount.getText().toString();
                x= String.valueOf(Integer.parseInt(x)+Integer.parseInt(balance));
                addlistCus();
                Intent iinent= new Intent(addbalance.this,wallet.class);
